...
<html lang="en">
  ...
  <body>
          ...
          <div class="container">
            ...
            <div class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li><a href="sell.php">Skin Care</a></li>
                <li><a href="about.php">Brushes & Tools</a>
    ...
    <div class="mainTitle">
    <div class="container">
    <h2 style="color:#c83a3a">LizCosmetics.com</h2>
    <p style="color:#5a5a5a">
    Your Number One Cosmetics Supplier
    </p>
    </div>
    </div>

    <h2 class="itemsTitle">Our Popular Brand</h2>
    ...
    <div class="introSection">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="cntr"> HaLorem Ipsum.<br>mission statement </h1>
            </div>
        </div>
        </div>
    </div>
     ...
     <div class="container marketing">
    <h2 class="itemsTitle">Lorem Ipsum</h2>
   ...
   <div id="myCarousel4" class="carousel slide" data-ride="carousel">
      ...
      <div class="row featurette">
        <div class="col-md-7">
          <h2 class="featurette-heading">Databases And PHP<span class="text-muted"> Liz Chiduku</span></h2>
